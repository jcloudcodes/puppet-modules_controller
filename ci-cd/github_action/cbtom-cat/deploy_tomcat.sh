...
MODULE_DIR="/etc/puppetlabs/code/environments/production/modules/tom_cat"
...
echo "Running Puppet validation for tom_cat..."
...
echo "tom_cat module deployment completed successfully."
